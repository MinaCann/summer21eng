...
public class String01 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println(s1.lastIndexOf('e'));//19 <== LastIndexOf() accepts char as parameter
	    ...
	    System.out.println(s1.lastIndexOf('a' , 5));//2 <== lastIndexOf() gets the first 5 characters in that example 
	                                                //      then returns the index of a
	    System.out.println(s1.lastIndexOf('a' , 10));//9
	    ...
	    /*How can you understand a character is used just once in a String by using indexOf() and lastIndex() methods
	     Ex: "HHellooo" ==> indexOf("H") --> 0 lastIndexOf("H") --> 1
	                         indexOf("H") --> 3 lastIndexOf("H") --> 4
	                         indexOf("e") --> 2 lastIndexOf("l") --> 2 =====>
	                         For non-repeated values indexOf() and lastIndex () methods 
	    */
	//10.Method: startssWith() <== Used to check the initial of a String + Returns boolean	
	String s2 = "Java is easy";
	
	System.out.println(s2.startsWith("J"));//true <== startsWith () method works just with Strings
	System.out.println(s2.startsWith("j")); // false case sensitive
	
	System.out.println(s2.startsWith("Java"));//true
	System.out.println(s2.startsWith("Javax"));//false
	
	System.out.println(s2.startsWith("i" , 5));//true<== After the 5 characters ,
	                                           //        Java will check if the next character is "i" or not
	 
	//11.Method: endsWith() <== Used to check the last of a String + Returns boolean	
	...
	System.out.println(s5.concat(s6).concat("Wooow") + 12 );
