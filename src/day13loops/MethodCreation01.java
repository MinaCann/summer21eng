...
public class MethodCreation01 {
	...
	*/
	...
	public static void main(String[] args) {     //add     //findSum   
	...
	/*
	 ...
	 c)Using different parameters name does not work
	...
	private static int add(int a, short b) {
		return a + b;
	}
	...
	public static int multiply(int x, int y, int z) {     //findProduct
