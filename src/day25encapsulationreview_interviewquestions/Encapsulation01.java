...
public class Encapsulation01 {
	...
	public static void main(String[] args) {
	   ...
	   1- What is Encapsulation?
	      ...
	      To make code block more safe, more usebility, flexsibilty,
       ...
       4- What is immutable class?
          NO need to create SETTERS
          Use just getters
          the class we cannot update
          
       5- What should be the return types for getter and setter?
          for setter---> void
          for getter---> int,String, double,....all but no void
          
             
       6- What are the features of encapsulation?
          reusebility
   ...
   /* 
     ...
     * preventing other classes from accessing directly the instance variable
