...
public class String01 {
	...
	public static void main(String[] args) {
		...
		System.err.println(s1.substring(8));// <== if you want to get all characters from a specific character to the last
		                                    //     character use substring() with a single parameter
...
//		
		...
		/*
		 ...
		 Example:
		 a)\\d ==> stands for all digits (0, 1, 3, 4, 5, 6, 7, 8, 9)
		   \\D==> stands for all characters different from digits
		  b) \\w==> stands for_and a-z and A-Z and 0-9
		     \\ W==>stands for characters different from _and a-z and A-Z and 0-9
		c) \\s ==> stands for space
		   \\S ==> stands for characters different from space
		d) \\ A ==> Beginning of the entire String
		   \\Z ==> End of the entire String
		e)[aby] ==> stands for all character a,b,y
		...
		//Example for d
		String s12 = "Java is easy";
		System.out.println(s12.replaceAll("\\A","Dollar"));
		System.out.println(s12.replaceAll("\\Z", "Dollar"));
		
		//Example for e)
		String s13 = " ali can bey ";
		System.out.println(s13.replaceAll("[clbya]", "*"));
		System.out.println(s13.replaceAll("[^aby]", "!"));
	}
