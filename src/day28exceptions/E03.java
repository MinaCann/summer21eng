...
public class E03 {
	...
	/*
	   ...
	   2) ArrayIndexOutOfBoundsExceptionis unchecked exception
	   
	   3) ArrayIndexOutOfBoundsException is thrown if you try to cast a data type to another which is not supported by Java
	   4) ArrayIndexOutOfBoundsException is an unchecked exception
	   
	   5) NumberFormatException is thrown if you use non-digit character in a String and use parseInt()
	   6) NumberFormatException is an unchecked exception
