...
public class Iterators01 {
    ...
    //How to remove all elements by using ListIterartor
    ...
    System.out.println(list4);//[X, V, Z, T, U, V]
	...
	//In Iterator, there is no hasPrevious() and previous() methods,because it is one-directional
