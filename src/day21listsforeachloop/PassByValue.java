...
public class PassByValue {
	...
	/*
	   1) If you use a variable inside a method, Java does not use the original variable inside method.
	      ...
	      This feature called "Pass by value" in Java
    ...
    */
	    ...
	    /*
	     ...
	     If you want to change , should do assignment like;
		 s = putQuestionMark(s);  
	   ...
	   /*
	     ...
	     Reference itself and copy of reference points the same objects, because of that when you call a method
