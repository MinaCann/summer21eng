...
public class AccessModifierRunner01 extends AccessModifier01{
	...
	public static void main(String[] args) {
		...
		AccessModifier01 obj1 = new AccessModifierRunner01();
         /*
            1) by using obj1, you cannot access to "profession" because "profession" is using
               private access modifier and you are in different class.
            ...
            3) By using obj1, you cannot access to "adress" because "adress" is using
