...
public class StaticBlock {
	...
	/*
	  static variable: Class variable, it is attached to the class and you should use class to access.
	  ...
	  static block: 1) It is used to initialize "class(static) variables"
	                2) Static block is executed before everything(contractors, methods, main method) inside the class
