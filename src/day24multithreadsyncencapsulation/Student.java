...
public class Student {
	...
	/*
	  ...
	  2) To read value of hidden variables, we create "getters", and by using "getters" we can read the value
	  ...
	  Note:Getter method names start with "get" followed by "variable name"
	       ...
	       boolean isOld = true; ==> Getter:isOld()   - n Setter: setOld()
	...
	public static void main (String[] args) {
		...
		//1.Way: Use default constructor
		//Student std1 = new Student();
		
		//2.Way: Create constructor with parameters
		//Student std2 = new Student("Ali Can", 13, true);
}
