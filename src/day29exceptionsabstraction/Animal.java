package day29exceptionsabstraction;
    ...
    /*
       ...
       5) Abstract methods must be overridden by child classes, otherwise you will get CTE 
          Note: If we think something is must for every child class, we make them abstract
                then child classes have to override them
       ...
       9) Abstract classes are classes because of that they have constructors,but constructors are not used to create object,
