	...
	/*
	    ...
	    1)Encapsulation:
	           ...
	           e)To create objects from classes in Java we have many ways;
	                ...
	                i)A obj1 = new(); ==> Fixed object
	                
	                ii)A obj2 = new("Veli Han", 13);
	                   A obj3 = new("Ayse Tan", 23);
	    ...
	    2)Polymorphism: Overloading + Overriding
	         ...
	         c)What is the difference between "Overloading" and "Overriding" ?
	              ...
	              iii)final methods can or cannot be overloaded, but final methods cannot be overridden.
