package day26inheritanceoverriding;
   ...
   /*
      ...
      5)super() can call constructors just from "parent class" not from "grant parent classes"
   */
...
public class Bird extends Mammal { 
	...
	public Bird() {
		...
		super(3);
         ...
         //this.//if you use this,then u will be able to see all variables whose names are different
		//from the class itself and from all parent classes
		//if u wanna see variables whose names are same from parent classes
		//do not use this. because you cannot see named variables by using this.
