...
public class String01 {
    ...
    //3.Method: length() ==> Counts(size) the number of characters in a String + Returns int
	...
	//7.Method: charAt() ==> Use it to get a specific character from a String + Returns character
		...
		//System.out.println(s6.charAt(13));// If you use index greater than the last index you will get error
	 ...
	 //8.Method : indexOf() ==> It returns index of specific character/s + Returns int
		...
		System.out.println(s8.indexOf("J")); //0 <== indexOf () method returns the index of first occurence of given character
		...
		System.out.println(s8.indexOf("ahha"));//-1<== If you use multiple characters, Java checks if the 
		                                      //      whole String exist in the given String then it returns the index of the first character
